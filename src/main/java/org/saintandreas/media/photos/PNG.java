...
public class PNG {
    ...
    /**
     * Sample implementation of a very basic reader that only loads the empty
     * chunks (except the IHDR). The IDAT are optional.
     */
    public static class PngReaderDumb {
        ...
        protected ChunkSeqReader createChunkSeqReader() {
            ChunkSeqSkipping cs = new ChunkSeqSkipping(false) { // don't check
                                                                // CRC
                @Override
